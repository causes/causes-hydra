  ...
  class Master
    ...
    def boot_ssh_worker(worker)
      ...
      command = worker.fetch('command') {
        "RAILS_ENV=#{@environment} ruby -e \"require 'rubygems'; require 'bundler/setup' if File.exist?('Gemfile'); require 'hydra'; Hydra::Worker.new(:io => Hydra::Stdio.new, :runners => #{runners}, :verbose => #{@verbose});\""
      }
